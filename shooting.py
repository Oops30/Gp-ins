...
pygame.display.set_caption("Shooting Game of Abhishekh T081")
...
while running:
    ...
    score_text = font.render(f"Score of T081: {score}", True, red)
...
game_over_text = font.render("Game Over T081", True, red)
